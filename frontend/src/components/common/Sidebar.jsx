...
export default function Sidebar({ active, setActive, currentUser, onLogout, mobileOpen, setMobileOpen }) {
  ...
  return (
    <>
      ...
      {/* ── Sidebar nav ── */}
      <nav className={`sidebar-nav ${mobileOpen ? 'sidebar-open' : ''}`} style={{ background: THEME.gradient }}>
